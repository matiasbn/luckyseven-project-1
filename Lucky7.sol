...
contract Lucky7 /*is usingOraclize*/{
    ...
    function getUserMuParameterValue(address _userID) public view returns (string){
        return userValues[_userID].mu;
        
    }

    function getUserIParameterValue(address _userID) public view returns (string){
        return userValues[_userID].i;
    }

    function getUserTicketValue(address _userID) public view returns (string){
        return userValues[_userID].ticketValue;
    }
