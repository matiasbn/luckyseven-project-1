...
contract('Lucky7Ballot', accounts => {
    ...
    //     let firstTicket = await lucky7Ballot.tickets(currentTicketID);
    ...
    //     let secondTicket = await lucky7Ballot.tickets(currentTicketID);
    ...
    //     currentTicketID = await lucky7Ballot.currentTicketID()
    //     let thirdTicket = await lucky7Ballot.tickets(currentTicketID);
    ...
    //     let Lucky7Ticket0 = await lucky7Ballot.lucky7Tickets(0)
    //     let Lucky7Ticket1 = await lucky7Ballot.lucky7Tickets(1)
    //     let Lucky7Ticket2 = await lucky7Ballot.lucky7Tickets(2)
    //     let Lucky7Ticket3 = await lucky7Ballot.lucky7Tickets(3)
    //     let Lucky7Ticket4 = await lucky7Ballot.lucky7Tickets(4)
    //     let Lucky7Ticket5 = await lucky7Ballot.lucky7Tickets(5)
    //     let Lucky7Ticket6 = await lucky7Ballot.lucky7Tickets(6)
...
//         //The contract balance would still be 7
//         await lucky7Ballot.setNewGame()
